...
from utils import logger as util
...
def parse_args(argv):
    ...
    parser.add_argument("--batch_size", type=int, default=16, help="Batch size (default: %(default)s)")  # 直接指定
    # parser.add_argument(
    #     "--test-batch-size",
    #     type=int,
    #     default=1,
...
def main(argv):
    ...
    train_dataloader = DataLoader(train_dataset, batch_size=args.batch_size, num_workers=8, shuffle=True, pin_memory=(device == "cuda"), drop_last=True)
