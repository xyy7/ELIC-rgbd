...
class ELIC_united_CPT(ELIC_united):
    def __init__(self, config, **kwargs):
        ...
        self.rgb_local_context_anchor_with_nonanchor = None
    ...
    def entropy_estimate_one_slice(
        ...
        depth_init_context = [depth_hyper_params]
        ...
        if idx != 0:
            ...
            depth_init_context = [depth_hyper_params, depth_channel_ctx]
        ...
        (rgb_slice_nonanchor, rgb_scales_nonanchor, rgb_means_nonanchor, rgb_y_hat_slice) = self.codeOnePart(
            rgb_slice_nonanchor,
        ...
        depth_slice_nonanchor, depth_scales_nonanchor, depth_means_nonanchor, depth_y_hat_slice = self.codeOnePart(
            ...
            [depth_local_ctx] + depth_init_context,
    ...
    def compress_one_slice(
        ...
        # depth-anchor
        depth_params_anchor = self.depth_entropy_parameters_anchor[idx](torch.cat(depth_init_context, dim=1))
        ...
        depth_params_nonanchor = self.depth_entropy_parameters_nonanchor[idx](
            torch.cat([depth_local_ctx] + depth_init_context, dim=1)
        )
