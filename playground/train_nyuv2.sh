python train2color.py -m ELIC --epochs 600 -lr 1e-4 --save --gpu_id 0 -q 1 --restore &
...
# python train2depth.py -m ELIC_dloss --epochs 400 -lr 1e-4 --save --gpu_id 4 -q 1 --restore --metric dloss&
# python train2depth.py -m ELIC_dloss --epochs 400 -lr 1e-4 --save --gpu_id 5 -q 2 --restore --metric dloss&
# python train2depth.py -m ELIC_dloss --epochs 400 -lr 1e-4 --save --gpu_id 6 -q 3 --restore --metric dloss&
# python train2depth.py -m ELIC_dloss --epochs 400 -lr 1e-4 --save --gpu_id 7 -q 4 --restore --metric dloss&

# python train2depth.py -m ELIC_dloss --epochs 400 -lr 1e-4 --save --gpu_id 0 -q 5 --restore --metric dloss&
# python train2depth.py -m ELIC_dloss --epochs 400 -lr 1e-4 --save --gpu_id 1 -q 6 --restore --metric dloss&
# python train2depth.py -m ELIC_dloss --epochs 400 -lr 1e-4 --save --gpu_id 2 -q 7 --restore --metric dloss&
# python train2depth.py -m ELIC_dloss --epochs 400 -lr 1e-4 --save --gpu_id 3 -q 0 --restore --metric dloss&
