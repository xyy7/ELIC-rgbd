...
## test_concat 
# python test.py --channel 4 -m ELIC_cat --gpu_id 6 -q 2 --dataset /data/xyy/nyu5k/nyuv2/test &
# python test.py --channel 4 -m ELIC_cat --gpu_id 7 -q 3 --dataset /data/xyy/nyu5k/nyuv2/test 
