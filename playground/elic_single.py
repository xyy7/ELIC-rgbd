...
class ELIC_single(CompressionModel):
    def __init__(self, config, return_mid=False, ch=3, **kwargs):
        ...
        self.g_s = SynthesisTransformEX(N, M, ch=ch, act=nn.ReLU, return_mid=True)
        # Hyper Transform
